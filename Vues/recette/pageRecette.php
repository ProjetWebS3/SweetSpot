...
<div id="popup<?=$i?>" class="border-2 border-black popup ml-auto mr-auto flex w-1/2 flex-col rounded-2xl bg-pink-50 text-xs md:text-base"> <?php } ?>
  <div class="flex flex-row justify-between">
    <div class="flex flex-row">
      <img src="/img/photoProfil.png" alt="Photo de profil" class="m-3 h-12 w-12 rounded-full">
...
<div class="bg-pink-50 p-4 rounded-lg mb-5">
    <div class="flex items-center mb-4">
      <img src="/img/photoProfil.png" alt="Photo de profil" id="imgButton<?=$i?>" class="w-12 h-12 rounded-full">
      <div class="ml-4">
        <div class="flex flex-row">
...
//Afficher les commentaires désactivés
    ...
    <div class="bg-gray-300 p-4 rounded-lg mb-5">
      <div class="flex items-center mb-4">
        <img src="/img/photoProfil.png" id="imgButton<?=$i?>" alt="Photo de profil" class="w-12 h-12 rounded-full">
        <div class="ml-4">
          <div class="flex flex-row">
          <h3 class="text-lg font-medium"><?= $A_vue['commentaire'][$i]['pseudo'] ?></h3>
          <?php
